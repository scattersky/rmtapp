...
function SingleTone() {
  ...
  if (loading || authLoading || authorLoading || reviewLoading || currentUserLoading)
    return (
      <div id='page'>
          ...
          <div className='flex flex-col-reverse md:flex-row min-h-[100vh] max-w-[1300px] w-full py-6 px-6 justify-between gap-6'>
            ...
            <div className='w-full md:w-[80%]'>
              <div className='flex flex-col items-center w-[100%] gap-4'>
                <div className='rounded-3xl mb-[10px] shadowwhite w-[100%] p-[20px] gap-[20px] flex flex-col md:flex-row justify-center border-[1px] border-[rgba(255,255,255,0.3)]'>
                  ...
                  {reviewData.map((review) => (
                    ...
                    >
                      ...
                      <p className='text-white text-[16px] mb-1'>
                        {replaceProfanities(review.review_text)}
                      </p>
                      <span className='text-gray-400 text-[10px] uppercase tracking-[1px]'>
                        Reviewed By: {review.review_author_name}
                      </span>
                      <span className='text-gray-400 text-[16px] ml-1 mr-1 opacity-60'>
                        {' '}
                        |{' '}
                      </span>
                      <span className='text-gray-400 text-[10px] uppercase tracking-[1px]'>
                      ...
                      {review.review_reply && (
                        <div className='border-gray-500 border-t p-4 mt-2'>
                          <span className='text-[#53A870] text-[12px] tracking-[1px] block'>
                            @{params.author_name} Replied:
                          </span>
